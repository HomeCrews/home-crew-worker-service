...
|---|---|
| Port | 8085 |
| Route through the gateway | `/workers/**` |
| Java package | `com.homecrew.workerservice` |
| Maven artifact | `workerservice` |
| Image | `mthanuj/homecrew-worker-service:dev` |
| Compose service | `worker-service` |
| Database | `homecrew_worker` |
| Default branch | `dev` |
...
A push to `dev` builds the image and pushes two tags to Docker Hub:
    ...
    mthanuj/homecrew-worker-service:sha-<short>
